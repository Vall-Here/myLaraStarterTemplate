...
<head>
  ...
  <link href="{{asset('assets\css\vendors\font-awesome.css')}}" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  
  <link href="{{asset('assets/css/nucleo-svg.css')}}" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" type="text/css" href="{{asset('assets/css/soft-ui-dashboard.css')}}" rel="stylesheet" />
  @stack('styles')
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="" class="font-weight-bold" target="_blank">Vall</a>
