                    ...
                    <div class="col-lg-12">
                        <div class="main-menu">
                            ...
                            <div class="menu-right">
                                <ul>
                                    <li>
                                        <div class="search-box theme-bg-color rounded-3">
                                    ...
                                    <li class="onhover-dropdown ">
                                        <div class="cart-media name-usr rounded-3">
                                            @auth
                                            ...
                                            <ul>
                                                @if (Route::has('login'))
                                                    @auth
                                                        ...
                                                        <li>
                                                            <a href="{{route('myAdmin.index')}}" class="d-block">Dashboard</a>
                                                        </li>
                                                        @else
                                                        <li>
                                                            <a href="{{route('myAccount.index')}}" class="d-block">My Account</a>
                                                        </li>
                                                        @endif
                                                        <li>
                                                            <a href="{{route('user.logout')}}"  class="d-block">Logout</a>
